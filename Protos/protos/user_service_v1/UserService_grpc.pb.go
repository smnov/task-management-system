...
func (c *userV1Client) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user_service.UserV1/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userV1Client) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user_service.UserV1/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userV1Client) GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user_service.UserV1/GetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userV1Client) UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*UpdateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user_service.UserV1/UpdateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userV1Client) DeleteUser(ctx context.Context, in *DeleteUserRequest, opts ...grpc.CallOption) (*DeleteUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user_service.UserV1/DeleteUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userV1Client) CheckUser(ctx context.Context, in *CheckUserRequest, opts ...grpc.CallOption) (*CheckUserResponse, error) {
	out := new(CheckUserResponse)
	err := c.cc.Invoke(ctx, "/user_service.UserV1/CheckUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserV1Server) CheckUser(context.Context, *CheckUserRequest) (*CheckUserResponse, error) {
...
func _UserV1_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.UserV1/CreateUser",
	}
...
func _UserV1_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.UserV1/Login",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserV1_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.UserV1/GetUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserV1_UpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.UserV1/UpdateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserV1_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.UserV1/DeleteUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserV1_CheckUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserV1Server).CheckUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.UserV1/CheckUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserV1Server).CheckUser(ctx, req.(*CheckUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserV1_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "user_service.UserV1",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserV1_CheckUser_Handler,
		},
	},
